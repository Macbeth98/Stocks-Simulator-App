            ...
            var i,
                ...
                funescape = function (escape, nonHex) {
                    ...
                    return nonHex ?
                        ...
                        // point
                        // Support: IE <=11+
                        // For values outside the Basic Multilingual Plane (BMP), manually
...
// Expose support vars for convenience
            ...
            isXML = Sizzle.isXML = function (elem) {
                ...
                // Support: IE <=8
                // Assume HTML when documentElement doesn't yet exist, such as inside loading
                // iframes https://bugs.jquery.com/ticket/4833
            ...
            setDocument = Sizzle.setDocument = function (node) {
                ...
                // (jQuery #13936) Support: IE 11+, Edge 17 - 18+ IE/Edge sometimes throw a
                // "Permission denied" error when strict-comparing two documents; shallow
                // comparisons work. eslint-disable-next-line eqeqeq
                ...
                // Support: IE 8 - 11+, Edge 12 - 18+, Chrome <=16 - 25 only, Firefox <=3.6 - 31
                // only, Safari 4 - 5 only, Opera <=11.6 - 12.x only IE/Edge & older browsers don't
                // support the :scope pseudo-class. Support: Safari 6.0 only Safari 6.0 supports
                // :scope but it's an alias of :root there.
                ...
                sortOrder = hasCompare ?
                            function (a, b) {
                                ...
                                if (compare & 1 ||
                                    ...
                                    // document Support: IE 11+, Edge 17 - 18+ IE/Edge sometimes
                                    // throw a "Permission denied" error when strict-comparing two
                                    // documents; shallow comparisons work.
                                    // eslint-disable-next-line eqeqeq
            ...
            function matcherFromGroupMatchers(elementMatchers, setMatchers) {
                var bySet = setMatchers.length > 0,
                    ...
                    superMatcher = function (seed, context, xml, results, outermost) {
                        ...
                        // above loop because we have no element matchers and no seed. Incrementing
                        // an initially-string "0" `i` allows `i` to remain a string only in that
                        // case, which will result in a "00" `matchedCount` that differs from `i`
                        // but is also numerically zero.
                ...
                if (match.length === 1) {
                    ...
                    if (tokens.length > 2 && (token = tokens[0]).type === "ID" &&
                        ...
                        context = (Expr.find["ID"](token.matches[0]
                                                       .replace(runescape, funescape), context)
                                   || [])[0];
                        if (!context) {
                            return results;
    ...
    function adoptValue(value, resolve, reject, noValue) {
        ...
        try {
            ...
            if (value && isFunction((method = value.promise))) {
                ...
                // integer: * false: [ value ].slice( 0 ) => resolve( value ) * true: [ value
                // ].slice( 1 ) => resolve()
                                  ...
                                  pipe: function ( /* fnDone, fnFail, fnProgress */) {
                                      ...
                                      return jQuery.Deferred(function (newDefer) {
                                          jQuery.each(tuples, function (_i, tuple) {
                                              ...
                                              // newDefer.notify }) deferred.done(function() { bind
                                  ...
                                  then: function (onFulfilled, onRejected, onProgress) {
                                      ...
                                      function resolve(depth, deferred, handler, special) {
                                          return function () {
                                              var that = this,
                                                  ...
                                                  mightThrow = function () {
                                                      ...
                                                      then = returned &&
                                                             ...
                                                             // Only check objects and functions
                                                             // for thenability
                                                      ...
                                                      if (isFunction(then)) {
                                                          ...
                                                          if (special) {
                                                              ...
                                                              // Normal processors (resolve) also
                                                              // hook into progress
                                                          } else {
                                                          ...
                                                          // context and multiple values (non-spec
                                                          // behavior)
                                                          if (handler !== Identity) {
                                                              that = undefined;
                                                              args = [returned];
                                                          ...
                                                          (special || deferred.resolveWith)(that,
                                                                                            args);
                                                      }
                                                  },
                                              ...
                                              // rejection from subsequent errors
                                              if (depth) {
                                                  process();
                                              } else {

                                                  // Call an optional hook to record the stack, in
                                                  // case of exception since it's otherwise lost
...
//	6. Provide a clear path for implementation upgrade to WeakMap in 2014
    ...
    function adjustCSS(elem, prop, valueParts, tween) {
        ...
        if (initialInUnit && initialInUnit[3] !== unit) {
            ...
            // Support: Firefox <=54
            // Halve the iteration target value to prevent interference from CSS upper bounds
            // (gh-2144)
            initial = initial / 2;
    ...
    function showHide(elements, show) {
        ...
        for (; index < length; index++) {
            ...
            if (show) {
                ...
                // (either inline or about-to-be-restored)
                if (display === "none") {
    ...
    jQuery.event = {
        ...
        handlers: function (event, handlers) {
            ...
            if (delegateCount &&
                ...
                // Support: Firefox <=42
                // Suppress spec-violating clicks indicating a non-primary pointer button
                // (trac-3861) https://www.w3.org/TR/DOM-Level-3-Events/#event-type-click Support:
                // IE 11 only ...but not arrow key "clicks" of radio inputs, which can have
                // `button` -1 (gh-2343)
        ...
        jQuery.event.add(el, type, {
            ...
            handler: function (event) {
                ...
                if ((event.isTrigger & 1) && this[type]) {
                    ...
                    // Saved data should be false in such cases, but might be a leftover capture
                    // object from an async native handler (gh-4350)
                    if (!saved.length) {

                        // Store arguments for use when handling the inner native event
                        // There will always be at least one argument (an event object), so this
                        // array will not be confused with a leftover capture object.
                        ...
                        // surrogate (focus or blur), assume that the surrogate already propagated
                        // from triggering the native event and prevent that from happening again
                        // here. This technically gets the ordering wrong w.r.t. to `.trigger()`
                        // (in which the bubbling surrogate propagates *after* the non-bubbling
                        // base), but that seems less bad than duplication.
...
// Return a potentially-mapped jQuery.cssProps or vendor prefixed property
    ...
    function boxModelAdjustment(elem, dimension, box, isBorderBox, styles, computedVal) {
        ...
        if (!isBorderBox && computedVal >= 0) {
            ...
            // offsetWidth/offsetHeight is a rounded sum of content, padding, scroll gutter, and
            // border Assuming integer scroll gutter, subtract the rest and round down
    ...
    jQuery.extend({
                      ...
                      style: function (elem, name, value, extra) {
                          ...
                          if (value !== undefined) {
                              ...
                              // properties) The isCustomProp check can be removed in jQuery 4.0
                              // when we only auto-append "px" to a few hardcoded values.
 ...
 */
		...
		*/
                      ...
                      ajax: function (url, options) {
                          ...
                          if (s.crossDomain == null) {
                              ...
                              // malformed, e.g. http://example.com:80x/
                              try {
                          ...
                          if (!s.hasContent) {
                              ...
                              if (s.cache === false) {
                                  ...
                                  uncached =
                                      (rquery.test(cacheURL) ? "&" : "?") + "_=" + (nonce.guid++) +
                                      uncached;
                              }
    ...
    jQuery._evalUrl = function (url, options, doc) {
        return jQuery.ajax({
                               ...
                               // dataFilter is not invoked for failure responses, so using it
                               // instead of the default converter is kludgy but it works.
                               converters: {
...
// keepScripts (optional): If true, will include scripts passed in the html string
    ...
    jQuery.fn.extend({
                         ...
                         // padding box This corresponds to the behavior of CSS absolute
                         // positioning
                         position: function () {
                             if (!this[0]) {
                                 return;
                             ...
                             if (jQuery.css(elem, "position") === "fixed") {
                                 ...
                                 // or its root element when a statically positioned element is
                                 // identified
                                 doc = elem.ownerDocument;
                         ...
                         // will return documentElement of the parent window 2) For the hidden or
                         // detached element 3) For body or html element, i.e. in case of the html
                         // node - it will return itself  but those exceptions were never presented
                         // as a real life use-cases and might be considered as more preferable
                         // results.  This logic, however, is not guaranteed and can change at any
                         // point in the future
